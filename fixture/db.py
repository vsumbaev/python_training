    ...
    def get_contacts_list(self):
        ...
        try:
            ...
            for row in cursor:
                ...
                list.append(Contact(id=str(id), name=firstname, middlename=middlename, last_name=lastname, nick=nickname,
                                    company=company, title=title, address=address, homephone=home, mobile=mobile,
